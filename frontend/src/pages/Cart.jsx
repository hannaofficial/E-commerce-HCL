    ...
    return products.length > 0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-16">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <button onClick={user ? placeOrder : () => setShowUserLogin(true)} className="w-full py-3 mt-6 cursor-pointer bg-primary text-white font-medium hover:bg-primary-dull transition">
                    {user ? (paymentOption === "COD" ? "Place Order" : "Proceed to Checkout") : "Login to Place Order"}
                </button>
            </div>
        </div>
    ) : null
